...
import type { ClientConfig, ConfigSaveResult, ConfigStatusResult, ConfigTransferResult, ImageModelTestResult, ModelInfoResult, ModelListResult, UpdateChannel } from './config';
...
export interface YibiaoBridge {
  ...
  config: {
    ...
    status: () => Promise<ConfigStatusResult>;
    export: () => Promise<ConfigTransferResult>;
    import: () => Promise<ConfigTransferResult>;
